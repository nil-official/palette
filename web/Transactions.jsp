...
<html>
    <head>
        ...
        <link rel="stylesheet" href="CSS/admintras.css">
        <%!
    ...
    <body>
        <div id="mySidenav" class="sidenav">
            ...
            <a href="#" class="icon-a tras"><i class="fa-solid fa-sack-dollar icons"></i> &nbsp;&nbsp;Transactions</a>
...
<!--            <span style="font-weight: bold; font-size: 150%">!!!Hello Users!!!</span>-->
            <span>
                <form class="search" method="POST" action="Transactions.jsp">
        ...
        <%
            ...
            if (request.getParameter("bSearch") != null) {
                ...
                q = "select uemail, pid, pdate, pamount from users where uemail=?";
        ...
        <form method="POST" action="Transactions.jsp">
            <button class="back-btn" type="submit">Display all Transactions</button>
        </form>
        <%                        } else {
                ...
                //STEP 4: CREATING THE QUERY
                q = "select uemail, pid, pdate, pamount from USERS order by uemail desc";
        ...
        <div class="col-div-8">
           ...
           <!--            <form method="POST" action="http://localhost:8080/WebBCASecB/DelUser?uname="  onsubmit=" return funDelete()">
                                <td><button type="submit">Delete</button></td>
                                </form>-->
<!--                                <td><form method="POST" action="http://localhost:8080/PALETTE/deluser?UEMAIL=" onsubmit="return funSub()">
