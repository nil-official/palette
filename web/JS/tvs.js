...
let json_url = "JS/tvs.json";
fetch(json_url).then(Response => Response.json())
    .then((data) => {
        data.forEach((ele,i) => {
            let{name,imdb,date,sposter,bposter,genre,url,ep1,ep2,ep3,ep4,ep5}=ele;
            ...
            <div class="rest_card">
                <img src="${bposter}" alt="">
        <div class="dropdown">
	<i id="button" class="fa-solid fa-circle-info fa-beat" style="color: #ff0000"></i>
